...
void loop()
{
  ...
  curPos5=90.0;
  curPos6=0.0;
  float Xhome[6]={164.5, 7.0, 241.0, 90.0, 180.0, -90.0}; // {192.5, 7.0, 269.0, 0.0, 90.01, 180.0};
  float X1[6]={164.5, 7.0, 141.0, 90.0, 180.0, -90.0};
  float X2[6]={264.5, 7.0, 141.0, 0.0, 90.0, 0.0};
  float X3[6]={164.5, 107.0, 141.0, 90.0, 90.0, 0.0};
  float X4[6]={164.5, -93.0, 141.0, 90.0, -90.0, 0.0};
